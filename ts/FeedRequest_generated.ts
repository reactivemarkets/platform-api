...
/**
 * @returns Switchboard.SubReqType
 */
subReqType():NS17503805021538163740.Switchboard.SubReqType {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? /**  */ (this.bb!.readInt8(this.bb_pos + offset)) : NS17503805021538163740.Switchboard.SubReqType.Subscribe;
};

/**
 * @returns Switchboard.FeedType
 */
feedType():NS17503805021538163740.Switchboard.FeedType {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? /**  */ (this.bb!.readInt16(this.bb_pos + offset)) : NS17503805021538163740.Switchboard.FeedType.Default;
};
...
/**
 * @param flatbuffers.Builder builder
 * @param Switchboard.SubReqType subReqType
 */
static addSubReqType(builder:flatbuffers.Builder, subReqType:NS17503805021538163740.Switchboard.SubReqType) {
  builder.addFieldInt8(1, subReqType, NS17503805021538163740.Switchboard.SubReqType.Subscribe);
};

/**
 * @param flatbuffers.Builder builder
 * @param Switchboard.FeedType feedType
 */
static addFeedType(builder:flatbuffers.Builder, feedType:NS17503805021538163740.Switchboard.FeedType) {
  builder.addFieldInt16(2, feedType, NS17503805021538163740.Switchboard.FeedType.Default);
};
...
static create(builder:flatbuffers.Builder, reqIdOffset:flatbuffers.Offset, subReqType:NS17503805021538163740.Switchboard.SubReqType, feedType:NS17503805021538163740.Switchboard.FeedType, grouping:number, depth:number, frequency:number, marketsOffset:flatbuffers.Offset):flatbuffers.Offset {
