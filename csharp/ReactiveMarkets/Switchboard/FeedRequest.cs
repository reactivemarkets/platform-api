...
public struct FeedRequest : IFlatbufferObject
{
  ...
  public ReactiveMarkets.Switchboard.SubReqType SubReqType { get { int o = __p.__offset(6); return o != 0 ? (ReactiveMarkets.Switchboard.SubReqType)__p.bb.GetSbyte(o + __p.bb_pos) : ReactiveMarkets.Switchboard.SubReqType.Subscribe; } }
  public ReactiveMarkets.Switchboard.FeedType FeedType { get { int o = __p.__offset(8); return o != 0 ? (ReactiveMarkets.Switchboard.FeedType)__p.bb.GetShort(o + __p.bb_pos) : ReactiveMarkets.Switchboard.FeedType.Default; } }
  ...
  public static Offset<ReactiveMarkets.Switchboard.FeedRequest> CreateFeedRequest(FlatBufferBuilder builder,
      StringOffset req_idOffset = default(StringOffset),
      ReactiveMarkets.Switchboard.SubReqType sub_req_type = ReactiveMarkets.Switchboard.SubReqType.Subscribe,
      ReactiveMarkets.Switchboard.FeedType feed_type = ReactiveMarkets.Switchboard.FeedType.Default,
      ushort grouping = 0,
      short depth = 0,
      short frequency = 0,
  ...
  public static void AddSubReqType(FlatBufferBuilder builder, ReactiveMarkets.Switchboard.SubReqType subReqType) { builder.AddSbyte(1, (sbyte)subReqType, 1); }
  public static void AddFeedType(FlatBufferBuilder builder, ReactiveMarkets.Switchboard.FeedType feedType) { builder.AddShort(2, (short)feedType, 0); }
  ...
  public static Offset<ReactiveMarkets.Switchboard.FeedRequest> EndFeedRequest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ReactiveMarkets.Switchboard.FeedRequest>(o);
  }
};
