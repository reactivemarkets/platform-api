...
public struct FeedRequestAccept : IFlatbufferObject
{
  ...
  public static Offset<ReactiveMarkets.Switchboard.FeedRequestAccept> CreateFeedRequestAccept(FlatBufferBuilder builder,
  ...
  public static Offset<ReactiveMarkets.Switchboard.FeedRequestAccept> EndFeedRequestAccept(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ReactiveMarkets.Switchboard.FeedRequestAccept>(o);
  }
};
