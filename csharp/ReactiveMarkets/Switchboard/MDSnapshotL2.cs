...
public struct MDSnapshotL2 : IFlatbufferObject
{
  ...
  public ReactiveMarkets.Switchboard.MDLevel2? BidSide(int j) { int o = __p.__offset(18); return o != 0 ? (ReactiveMarkets.Switchboard.MDLevel2?)(new ReactiveMarkets.Switchboard.MDLevel2()).__assign(__p.__vector(o) + j * 16, __p.bb) : null; }
  public int BidSideLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
  public ReactiveMarkets.Switchboard.MDLevel2? OfferSide(int j) { int o = __p.__offset(20); return o != 0 ? (ReactiveMarkets.Switchboard.MDLevel2?)(new ReactiveMarkets.Switchboard.MDLevel2()).__assign(__p.__vector(o) + j * 16, __p.bb) : null; }
  public int OfferSideLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<ReactiveMarkets.Switchboard.MDSnapshotL2> CreateMDSnapshotL2(FlatBufferBuilder builder,
      long source_ts = 0,
  ...
  public static Offset<ReactiveMarkets.Switchboard.MDSnapshotL2> EndMDSnapshotL2(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 8);  // market
    return new Offset<ReactiveMarkets.Switchboard.MDSnapshotL2>(o);
  }
};
