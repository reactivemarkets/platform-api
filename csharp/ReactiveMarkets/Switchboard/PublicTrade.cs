...
public struct PublicTrade : IFlatbufferObject
{
  ...
  public static Offset<ReactiveMarkets.Switchboard.PublicTrade> CreatePublicTrade(FlatBufferBuilder builder,
      long source_ts = 0,
  ...
  public static Offset<ReactiveMarkets.Switchboard.PublicTrade> EndPublicTrade(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 8);  // market
    return new Offset<ReactiveMarkets.Switchboard.PublicTrade>(o);
  }
};
